<?php
    ...
    if(isset($_SESSION['steamid'])){
      include_once($_SERVER['DOCUMENT_ROOT'] . "/php/default.php");
    	include($_SERVER['DOCUMENT_ROOT'] . "/php/steamauth/settings.php");
        if (empty($_SESSION['steam_uptodate']) or $_SESSION['steam_uptodate'] == false or empty($_SESSION['steam_personaname'])) {
            ...
            @$url = getUserStr($_SESSION['steamid']);
    ...
    $steamprofile['personaname'] = strip_tags($steamprofile['personaname']);
    $steamprofile['personaname'] = str_replace(".com","",$steamprofile['personaname']);
    $steamprofile['personaname'] = str_replace(".Com","",$steamprofile['personaname']);
    $steamprofile['personaname'] = str_replace(".COM","",$steamprofile['personaname']);
    $steamprofile['personaname'] = str_replace(".org","",$steamprofile['personaname']);
    $steamprofile['personaname'] = str_replace(".Org","",$steamprofile['personaname']);
    $steamprofile['personaname'] = str_replace(".ORG","",$steamprofile['personaname']);
    $steamprofile['personaname'] = str_replace(".net","",$steamprofile['personaname']);
    $steamprofile['personaname'] = str_replace(".Net","",$steamprofile['personaname']);
    $steamprofile['personaname'] = str_replace(".NET","",$steamprofile['personaname']);
    }
?>
